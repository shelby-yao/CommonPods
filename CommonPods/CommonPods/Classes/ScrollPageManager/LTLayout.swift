...
public class LTLayout: NSObject {
    public struct LTTitleLayout {
     
        /* 标题背景色 */
       public var titleBackColor: UIColor?
        /* 标题选中背景色 */
       public var titleSelectBackColor: UIColor?
        /* 标题宽度 */
       ...
       public var titleMargin: CGFloat
        /* 标题颜色，请使用RGB赋值 */
    ...
    /* 标题内容设置 */
    public var ltTitleLayout = LTTitleLayout(
                            titleBackColor: nil,
                            titleSelectBackColor: nil,
                            titleWidth: 0,
                            titleHeight: 0,
                            titleFont: UIFont.systemFont(ofSize: 16),
                            titleMargin: 30.0,
                            titleColor: NORMAL_BASE_COLOR,
                            titleSelectColor: SELECT_BASE_COLOR,
                            titleCornerRadius:nil)
