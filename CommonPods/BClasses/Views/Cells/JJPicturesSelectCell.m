...
@implementation JJPicturesSelectCell
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        NSBundle *resourcesBundle = [NSBundle bundleWithPath:[mainBundle pathForResource:@"business" ofType:@"bundle"]];
        
        if (resourcesBundle == nil) {
            resourcesBundle = mainBundle;
        }
        UIImage *img = [UIImage imageNamed:@"icon_delete_v" inBundle:resourcesBundle compatibleWithTraitCollection:nil];
